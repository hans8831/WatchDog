...
class CalloutView: UIView {
    ...
    private let bubbleLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor(red: 198 / 255.0, green: 3 / 255.0, blue: 3 / 255.0, alpha: 1).cgColor
        layer.fillColor = UIColor(red: 198 / 255.0, green: 3 / 255.0, blue: 3 / 255.0, alpha: 1).cgColor
        layer.lineWidth = 0.5
        return layer
    }()
